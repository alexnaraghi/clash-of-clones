...
namespace VRStandardAssets.Menu
{
    ...
    public class MenuAnimator : MonoBehaviour
    {
        ...
        {
            m_VRInteractiveItem.OnOver.AddListener(HandleOver);
            m_VRInteractiveItem.OnOut.AddListener(HandleOut);
        }


        private void OnDisable ()
        {
            m_VRInteractiveItem.OnOver.RemoveListener(HandleOver);
            m_VRInteractiveItem.OnOut.RemoveListener(HandleOut);
        }
