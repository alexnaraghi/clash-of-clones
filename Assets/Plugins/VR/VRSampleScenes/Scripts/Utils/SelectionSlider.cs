...
namespace VRStandardAssets.Utils
{
    ...
    public class SelectionSlider : MonoBehaviour
    {
        ...
        private void OnEnable ()
        {
            ...
            m_InteractiveItem.OnOver.AddListener(HandleOver);
            m_InteractiveItem.OnOut.AddListener(HandleOut);
        }
        ...
        private void OnDisable ()
        {
            ...
            m_InteractiveItem.OnOver.RemoveListener(HandleOver);
            m_InteractiveItem.OnOut.RemoveListener(HandleOut);
        }
