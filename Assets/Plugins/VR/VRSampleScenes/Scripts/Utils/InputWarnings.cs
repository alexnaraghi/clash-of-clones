...
namespace VRStandardAssets.Utils
{
    ...
    public class InputWarnings : MonoBehaviour
    {
        ...
        private SwipeDirection m_CurrentSwipe;                                  // The swipe being used this frame, this is used to determine whether a click is a swipe.
        ...
        private void HandleClick ()
        {
            ...
            if (m_ShowSingleTapWarnings && m_CurrentSwipe == SwipeDirection.NONE)
